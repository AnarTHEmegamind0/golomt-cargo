...
CREATE INDEX `admin_activity_log_actor_user_id_idx` ON `admin_activity_log` (`actor_user_id`);--> statement-breakpoint
CREATE INDEX `admin_activity_log_action_idx` ON `admin_activity_log` (`action`);--> statement-breakpoint
CREATE INDEX `admin_activity_log_target_type_idx` ON `admin_activity_log` (`target_type`);--> statement-breakpoint
CREATE INDEX `admin_activity_log_created_at_idx` ON `admin_activity_log` (`created_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `import_batch_source_type_idx` ON `import_batch` (`source_type`);--> statement-breakpoint
CREATE INDEX `import_batch_created_by_user_id_idx` ON `import_batch` (`created_by_user_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `shipment_vehicle_id_idx` ON `shipment` (`vehicle_id`);--> statement-breakpoint
CREATE INDEX `shipment_status_idx` ON `shipment` (`status`);--> statement-breakpoint
CREATE INDEX `shipment_created_by_user_id_idx` ON `shipment` (`created_by_user_id`);--> statement-breakpoint
...
CREATE INDEX `vehicle_created_by_user_id_idx` ON `vehicle` (`created_by_user_id`);--> statement-breakpoint
...
INSERT INTO `__new_cargo`(
	...
	"created_at",
	"updated_at"
FROM `cargo`;--> statement-breakpoint
...
CREATE INDEX `cargo_shipment_id_idx` ON `cargo` (`shipment_id`);--> statement-breakpoint
...
CREATE INDEX `cargo_import_batch_id_idx` ON `cargo` (`import_batch_id`);--> statement-breakpoint
